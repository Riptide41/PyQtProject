...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dict_4 = QtWidgets.QLabel(self.centralwidget)
        self.dict_4.setMinimumSize(QtCore.QSize(204, 114))
        self.dict_4.setObjectName("dict_4")
        self.verticalLayout_4.addWidget(self.dict_4)
        self.dict_4_info = QtWidgets.QLabel(self.centralwidget)
        self.dict_4_info.setObjectName("dict_4_info")
        self.verticalLayout_4.addWidget(self.dict_4_info)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dict_1.setText(_translate("MainWindow", "塑件1——图片"))
        self.dict_1_info.setText(_translate("MainWindow", "塑件1——信息"))
        self.dict_2.setText(_translate("MainWindow", "塑件2——图片"))
        self.dict_2_info.setText(_translate("MainWindow", "塑件2——信息"))
        self.dict_3.setText(_translate("MainWindow", "塑件3——图片"))
        self.dict_3_info.setText(_translate("MainWindow", "塑件3——信息"))
        self.dict_4.setText(_translate("MainWindow", "塑件4——图片"))
        self.dict_4_info.setText(_translate("MainWindow", "塑件4——信息"))
